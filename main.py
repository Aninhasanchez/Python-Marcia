...
def disparar_email_aviso(mensagem_aviso):
    remetente_email = "analuisasanchez05@gmail.com"  # Conta de e-mail de origem
    destinatario_email = "analuisasanchez05@gmail.com"  # Conta de e-mail de destino
    senha_acesso = "izff jafm ipad nqti"  # App Password ou senha do e-mail
